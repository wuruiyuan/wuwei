    ...
    <div id="mws-header" class="clearfix">
        ...
        <div id="mws-logo-container">
            ...
            <div id="mws-logo-wrap">
                <img src="/home/picture/logo.gif" class="png_bg" width="100" height="40">
            </div>
        </div>

        <div class="logo-head" style="positon:relative;margin-top:18px;margin-left:5px;float:left;background:#0c82d9;height:23px;width:72px;border-radius:5px;-moz-border-radius: 5px;-webkit-border-radius: 5px;">
            <a href="/home/index" class="in_b" width="72">
                <img src="/home/picture/home.png" class="png_bg" style="display:inline;margin:3px 8px 3px 6px;float:left;" width="17" height="17">
        ...
        <div id="mws-user-tools" class="clearfix">
            ...
            <div id="mws-user-info" class="mws-inset">
                ...
                <div id="mws-user-functions">
                    ...
                    <ul>
                        <li><a href="/admin/toxiang">修改头像</a></li>
